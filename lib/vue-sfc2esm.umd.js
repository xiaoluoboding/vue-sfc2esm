...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@vue/compiler-sfc'), require('@vue/shared'), require('vue'), require('@vue/compiler-sfc/dist/compiler-sfc.esm-browser')) :
  typeof define === 'function' && define.amd ? define(['exports', '@vue/compiler-sfc', '@vue/shared', 'vue', '@vue/compiler-sfc/dist/compiler-sfc.esm-browser'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['vue-sfc2esm'] = {}, global.sfcCompiler, global.shared, global.Vue, global.sfcCompilerEsm));
}(this, (function (exports, compilerSfc, shared, vue, defaultCompiler) { 'use strict';
  ...
  const IMPORT_MAP_CODE = `
{
  ...
  exports.recordFileErrors = recordFileErrors;
  exports.store = store;
