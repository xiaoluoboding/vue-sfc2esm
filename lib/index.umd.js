...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@vue/compiler-sfc/dist/compiler-sfc.esm-browser'), require('@vue/shared'), require('vue'), require('crypto')) :
  typeof define === 'function' && define.amd ? define(['exports', '@vue/compiler-sfc/dist/compiler-sfc.esm-browser', '@vue/shared', 'vue', 'crypto'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.sfc2esm = {}, global.sfcCompilerEsm, global.shared, global.Vue, global.Crypto));
}(this, (function (exports, defaultCompiler, shared, vue, Crypto) { 'use strict';
